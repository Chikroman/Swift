//
//  AllGroupsController+TableSourse.swift
//  les2_2
//
...
extension AllGroupController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configurate(group: Storage.share.allGroups[indexPath.row])
//        cell.configurate(image: nil, name: Storage.share.allGroups[indexPath.row], description: nil)
